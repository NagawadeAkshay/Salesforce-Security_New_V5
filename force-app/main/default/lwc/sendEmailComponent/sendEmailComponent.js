    ...
    */
        ...
        handleSelection(event) {
            ...
            if (value === 'None') {
                ...
                this.handleGroupsOption(event, value);
            }
            else {
        ...
        handleGroupsOption(event, value){
            ...
            if (listBoxOption.classList.contains("slds-is-selected")) {
                ...
                let intOption = this.template.querySelector('[data-id="Internal"]');
                intOption.firstChild.classList.remove("slds-is-selected");

                let extOption = this.template.querySelector('[data-id="External"]');
                extOption.firstChild.classList.remove("slds-is-selected");

                //
                let groupsOption = this.template.querySelector('[data-id="Groups"]');
                groupsOption.firstChild.classList.add("slds-is-selected");
            ...
            // let allOption = this.template.querySelector('[data-id="Groups"]');
            // allOption.firstChild.classList.add("slds-is-selected");
            this.closeDropbox();
        }
    }
        handleOption(event, value){
            ...
            if (listBoxOption.classList.contains("slds-is-selected")) {
                ...
                //
                let groupsOption = this.template.querySelector('[data-id="Groups"]');
                groupsOption.firstChild.classList.remove("slds-is-selected");

                //
                if(this.value.length){
                    if(this.value[0].label==('Groups')){
                        this.value = [];
                    }else{
                    }
                }
        ...
        callingfromEmailComponent(){
            ...
            let groupsOption = this.template.querySelector('[data-id="Groups"]');
            groupsOption.firstChild.classList.remove("slds-is-selected");
            let internalOption = this.template.querySelector('[data-id="Internal"]');
            internalOption.firstChild.classList.remove("slds-is-selected");
            let externalOption = this.template.querySelector('[data-id="External"]');
            externalOption.firstChild.classList.remove("slds-is-selected");
        }
}