...
if(enModifyMetadata == 'true' && setupCookiePresent == true) {
	...
	//spanElement.setAttribute("ng-click","techSupportLinksCollapsed = !techSupportLinksCollapsed; openSidebarConfigPage();");
...
technicalSupportLinkApp.controller('AccordionCtrlTSLink', function($q, $scope, $timeout) {
	...
	$scope.openLink = function(winURL,winNewWindow){       
...
technicalSupportLinkApp.directive('ngEnter', function () {
