	...
	$scope.fetchInitialData = function(cName,chartId){	  
		if($scope.chartStackedColumn_contextRecordId == ''){
			...
			Visualforce.remoting.Manager.invokeAction(
				_RemotingChartStackedColumnActions.fetchInitialData,cName,phaseNameParam ,chartId,isDashboard,$scope.newFilterClause,
			...
			Visualforce.remoting.Manager.invokeAction(
				_RemotingChartStackedColumnActions.fetchInitDataWithRecordId,cName,phaseNameParam,chartId,isDashboard,$scope.newFilterClause,$scope.chartStackedColumn_contextRecordId,
				paintBarStackedChart,
				{escape:false, buffer: false}
			);
		}
