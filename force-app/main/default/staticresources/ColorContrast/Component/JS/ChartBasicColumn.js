	...
	$scope.fetchInitialData = function(cName,chartId){
		if($scope.chartBasicColumn_contextRecordId == ''){
			...
			Visualforce.remoting.Manager.invokeAction(
				_RemotingChartBasicColumnActions.fetchInitialData,cName,phaseNameParam ,chartId,isDashboard,$scope.newFilterClause,
			...
			Visualforce.remoting.Manager.invokeAction(
				_RemotingChartBasicColumnActions.fetchInitDataWithRecordId,cName,phaseNameParam ,chartId,isDashboard,$scope.newFilterClause,$scope.chartBasicColumn_contextRecordId,
				paintColumnBasicChart,
				{escape:false, buffer: false}
			);
		}
