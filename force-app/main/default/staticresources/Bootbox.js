...
(function (root, factory) {
    ...
    let templates = {
      ...
      header:         '<div class="modal-header modal-header-ext"><h5 class="modal-title"></h5></div>',
          ...
          if (options.inputType !== 'date') {
            if (options.step) {
              if (options.step === 'any' || (!isNaN(options.step) && parseFloat(options.step) > 0)) {
                ...
                throw new Error('"step" must be a valid positive number or the value "any". See https://www.ssllabs.com/ssltest/analyze.html?d=www.w3schools.com for more information.');
              }
            }
          }
