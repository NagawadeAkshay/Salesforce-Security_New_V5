...
// Based on mirrors.ctan.org/language/hyph-utf8/tex/generic/hyph-utf8/patterns/tex/hyph-en-gb.tex
// Source www.ctan.org
...
`;
  ...
  return {
    ...
    function provideHyphenation(hyphenate, id) {
      ...
      var el = document.querySelector('.field-value');
      //var el = document.querySelectorAll(".testt");
      el.textContent = hyphenate(el.textContent);
    }

    provideHyphenation(createHyphenator(hyphenationPatternsEnGb), 'field-value');
